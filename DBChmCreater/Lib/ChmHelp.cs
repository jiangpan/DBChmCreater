 ...
 */
namespace DBChmCreater.Chm.Common
{
    /// <summary>
    /// Chm辅助类
    /// </summary>
    public class ChmHelp
    {
        ...
        public event Action<string, string> logHandle;
        #endregion

        #region hha 方法引入编译chm
        [DllImport("hha.dll")]
        ...
        private void Create(string path)
        {
            ...
            foreach (string filename in strFileNames)
            {
                ...
                fileItem.AppendLine($"		<param name=\"Local\" value=\"{filename.Replace(rootParent, string.Empty)}\">");
        ...
        private void CreateHHC()
        {
            ...
            code.AppendLine("<meta name=\"GENERATOR\" content=\"Microsoft&reg; HTML Help Workshop 4.1\">");
            ...
            code.AppendLine("	<param name=\"Window Styles\" value=\"0x800025\">"); //  原始 0x800025 -> 0x237
        ...
        private void CreateHHK()
        {
            ...
            code.AppendLine("</OBJECT>");
            code.AppendLine("<UL>");
            //遍历文件夹 构建hhc文件内容  关键字内容
            code.Append(hhkBody.ToString());
            code.AppendLine("</UL>");
            code.AppendLine("</BODY>");
            code.AppendLine("</HTML>");
            //File.WriteAllText(Path.Combine(SourcePath, "chm.hhk"), code.ToString(), Encoding.GetEncoding("gb2312"));
            File.WriteAllText(".//chm.hhk", code.ToString(), Encoding.GetEncoding("gb2312")); //System.Text.Encoding.GetEncoding("GB18030")
        }
        ...
        private void CreateHHP()
        {
            ...
            code.AppendLine("CITATION=Made by jiangpan");//制作人
            ...
            code.AppendLine("COPYRIGHT=www.synyi.com");//版权所有
            ...
            //code.AppendLine($"Main=\"{Title}\",\"chm.hhc\",\"chm.hhk\",\"{DefaultPage}\",\"{DefaultPage}\",,,,,0x63520,180,0x104E, [0,0,745,509],0x0,0x0,,,,,0");
            code.AppendLine($"Main=\"{Title}\",\"chm.hhc\",\"chm.hhk\",\"{DefaultPage}\",\"{DefaultPage}\",,,,,0x63520,180,0x104E, [0,0,745,509],0x0,0x0,,,,,0");
            ...
            File.WriteAllText(".//chm.hhp", code.ToString(), Encoding.GetEncoding("gb2312"));
        }
